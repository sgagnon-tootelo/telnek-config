-- Fix Supabase Security Advisor: Security Definer View on vw_appels_clients.
-- Recreate with security_invoker so RLS of the querying role applies to underlying tables.
